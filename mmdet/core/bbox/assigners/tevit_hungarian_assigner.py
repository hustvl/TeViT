...
class TeViTHungarianAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        for i in range(clip_length):
            ...
            # regression L1 cost
            normalize_gt_bboxes = gt_bboxes[i] / factor
        ...
        for gt_id in gt_ids:
            ...
            per_ims_to_total = gt_id.new_tensor(
                per_ims_to_total, dtype=torch.int64)
            ...
            totals_to_per_ims = gt_id.new_zeros(num_gts + 1, dtype=torch.int64)
        ...
        cost = sum(costs_) / sum(ims_to_total_weights)
